...
export class NetFooter extends HTMLElement {
    ...
    render(){
        ...
        <div class="flex flex-col w-full h-fit bg-[#374151] text-[#c7d7f8] px-10 py-5">
        <div class="flex flex-row">
            <div class="flex flex-col gap-2 justify-center w-[35%] w-[35%]">
                <div class="flex items-center w-full gap-4">
                    <img src="https://tailwind-generator.b-cdn.net/favicon.png" width="66" alt="Logo Preview">
                    <div class="text-3xl  ">M@rioNET001</div>
                </div>
            ...
            <div class="flex flex-row w-[65%] justify-end gap-16 text-nowrap">
                <div class="grid grid-cols-2 gap-16">
                    <div class="flex flex-col gap-2">
                        <div class="font-bold uppercase text-[#dddddd] pb-3">Comany</div> <a href="#xxx" class="hover:underline">About Us</a>  <a href="#xxx" class="hover:underline">Contact</a>  <a href="#xxx" class="hover:underline">Support</a>  <a href="#xxx" class="hover:underline">News</a>
    
                    </div>
                    <div class="flex flex-col gap-2">
                        <div class="font-bold uppercase text-[#dddddd] pb-3">Legal</div> <a href="#xxx" class="hover:underline">Imprint</a>  <a href="#xxx" class="hover:underline">Privacy Policy</a>  <a href="#xxx" class="hover:underline">Terms of Use</a>
    
                    </div>
                </div>
                <div class="flex flex-col gap-2">
                    <div class="font-bold uppercase text-[#dddddd] pb-3">Newsletter</div>
                    <p class="text-[#c7d7f8] mb-2">Subscribe to our newsletter.</p>
